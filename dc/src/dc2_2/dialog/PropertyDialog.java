...
import dc2_2.ButtonType;
import dc2_2.DigitalClock;
import dc2_2.PropertyInfo;
import dc2_2.PulldownList;
...
public class PropertyDialog extends abstractDialog implements ActionListener{
	...
	public PropertyDialog(){
		...
		this.fontFamilyPulldownList = initPulldownList(fontFamilyList,this.propertyInfo.getFontFamily(),listWidth,80);
		this.fontSizePulldownList = initPulldownList(fontSizeList,this.propertyInfo.getFontSize()+"",listWidth,130);
		this.charColorPulldownList = initPulldownList(colorList,this.propertyInfo.getCharColor(),listWidth,180);
		this.bgColorPulldownList = initPulldownList(colorList,this.propertyInfo.getBGColor(),listWidth,230);
	...
	private PulldownList initPulldownList(String[] items,String selectedItem,int x,int y) {
		PulldownList pulldownList = new PulldownList (items,selectedItem,x,y);
		add(pulldownList.getComboBox());
